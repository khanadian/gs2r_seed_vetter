...
def replace_obj(obj):
    ...
    static_obj["Collect the Teleport Lapis chest"] = [["pound","burst","blaze", "grind", "magma ball"], ["pound","burst","teleport", "grind", "magma ball"]]
    ...
    static_obj["Befriend the Djinni in Trial Road"] = [["shaman", "whirlwind", "hover", "lift", "reveal"]]
